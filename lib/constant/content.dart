...
const materi1B =
    "Here is the description of each part of the picture.\n1.	Nasal Cavity. The nasal sounds are /m/, /n/, and /ŋ/.\n2.	Oral Cavity. Some oral sounds are /tʃ/, /ʒ/, and /ð/. Most sounds are produced in oral cavity.\n3.	Alveolar Ridge is a small ridge just behind the upper front teeth. For example, /t/, /s/, /d/, /z/, /n/, /l/, and /r/.\n4.	Soft Palate is the soft portion of the roof of the mouth, lying behind the hard palate (i.e., /k/, /g/, /ŋ/).\n5.	Hard Palate is the roof of the mouth just behind the alveolar ridge (i.e., /ʃ/, /tʃ/, /ʒ/, /dʒ/).\n6.	Vocal Cords or Vocal Folds refer to a fold of tissue in the throat to indicate the vibration when the airstream is allowed to pass between them. It indicates a sound to be voiced or voiceless.";
const materi2 =
