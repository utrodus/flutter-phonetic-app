...
import 'package:phono/screen/pages/phonetic/wrong/32/contentwrong.dart';
import 'package:phono/screen/pages/phonetic/wrong/32/keyboardwrong.dart';

import 'package:phono/screen/style/config.dart';
import 'package:phono/screen/widgets/appbar.dart';

class Wrong32 extends StatelessWidget {
  final String simbol;
